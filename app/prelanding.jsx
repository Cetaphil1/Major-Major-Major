...
(function () {
  ...
  function PreLandingFlow() {
    ...
    const skipIntro = () => {
      // Honest skip: leave any partial context saved, but do not unlock the
      // personalized research/survey flow until college and major both exist.
      UC.update({ preLandingComplete: UC.hasIdentity() });
