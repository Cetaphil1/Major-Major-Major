...
(function () {
  ...
  function FlowApp() {
    ...
    useEffect(() => {
      if (uc && uc.preLandingComplete && hasIdentity) {
        FlowState.save({ phase, ctx, sectionIdx, answers }, uc);
      }
    }, [phase, ctx, sectionIdx, answers, hasIdentity]);
