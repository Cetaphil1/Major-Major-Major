...
(function () {
  ...
  function FlowApp() {
    ...
    const identityKey = FlowState ? FlowState.identityFromUserContext(uc) : "";
    const saved = FlowState ? FlowState.loadForIdentity(identityKey) : null;
    ...
    const currentIdentityKey = FlowState ? FlowState.identityFromContext(ctx) || identityKey : "";
    useEffect(() => {
      if (FlowState) FlowState.save({ phase, ctx, sectionIdx, answers }, currentIdentityKey);
