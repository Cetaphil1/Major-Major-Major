...
(function () {
  ...
  function FlowApp() {
    ...
    const identity = FlowState && FlowState.identityFromUserContext(uc);
    const saved = FlowState && FlowState.load(identity);
    React.useEffect(() => {
    ...
    useEffect(() => {
      if (FlowState) FlowState.save(identity, { phase, ctx, sectionIdx, answers });
    ...
    return <Report report={report}
      ...
      onRestart={() => { if (FlowState) FlowState.wipe(identity); toLanding(); }}
    />;
  }
