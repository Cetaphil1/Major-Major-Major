...
(function () {
  ...
  function FlowApp() {
    ...
    const flowScope = FlowState.scopedSavedForIdentity(uc);
    const identityKey = flowScope.identityKey;
    const saved = flowScope.saved;
    ...
    useEffect(() => { FlowState.saveRaw({ identityKey, phase, ctx, sectionIdx, answers }); }, [identityKey, phase, ctx, sectionIdx, answers]);
