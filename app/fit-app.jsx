...
(function () {
  ...
  // ── persistence ───────────────────────────────────────────────
  function load(uc) { return FlowState ? FlowState.load(uc) : null; }
  function save(s, uc) { if (FlowState) FlowState.save(s, uc); }
  function wipe() { if (FlowState) FlowState.wipe(); }
  ...
  function FlowApp() {
    ...
    useEffect(() => { save({ phase, ctx, sectionIdx, answers }, uc); }, [phase, ctx, sectionIdx, answers]);
