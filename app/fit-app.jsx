...
(function () {
  ...
  function FlowApp() {
    ...
    const saved = !shouldRedirect && FlowStore ? FlowStore.load(uc) : null;
    React.useEffect(() => {
    ...
    useEffect(() => {
      if (!shouldRedirect && FlowStore) {
        FlowStore.save({ phase, ctx, sectionIdx, answers }, uc);
      }
    }, [phase, ctx, sectionIdx, answers, shouldRedirect]);
